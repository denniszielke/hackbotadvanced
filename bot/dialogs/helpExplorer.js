...
module.exports = {
    ...
    dialog: [
        (session) => {
            answerHelper.facetQuery(facetName, (err, result) => {
                if (err) {
        ...
        (session, results) => {
            ...
            answerHelper.searchQuery(facetValue, (err, result) => {
                if (result) {
